...
from models.dbmodels import SessionData, ConferenceData
from helpers import super_admin_required, admin_required
...
class UtilitiesHomeHandler(BaseHandler):
    ...
    def get(self):
        ...
        self.render_response('utilities.html', 
                                access_token = ConferenceData.get_config().dbox_access_token, 
