...
_VALID_NAMED_DSID_RE = r'[a-z0-9_-]([a-z0-9._-]{0,62}[a-z0-9_-])?'
_VALID_UNNAMED_DSID_RE = r'\.[%s]{1,63}' % _DBASE64_VALID_CHARS
...
class Datastore(object):
    ...
    **Do not instantiate this class directly**.  Use the methods on
    ...
    def is_valid_id(id):
        ...
        Valid local datastore IDs are 1-64 characters long and
    ...
    def get_pending_changes_size(self):
        ...
        of those changes and :const:`Datastore.BASE_DELTA_SIZE`. If there are no pending
